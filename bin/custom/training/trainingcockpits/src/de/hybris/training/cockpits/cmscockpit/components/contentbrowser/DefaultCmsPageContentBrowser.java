 ...
 */
package de.hybris.training.cockpits.cmscockpit.components.contentbrowser;
...
import de.hybris.training.cockpits.cmscockpit.session.impl.DefaultCmsPageBrowserModel;
